...
#[Entity(table: "sumber")]
class SumberEntity extends AbstractEntity
{
	#[Id]
	#[Column(name: "id", type: "varchar", size: "14")]
	public string|null $id;

	#[Column(name: "kode", type: "varchar", size: "14")]
	...
	#[Column(name: "kode_rekening3", type: "varchar", size: "1")]
					...
					if ($this->kodeRekening4 !== null) {
						...
						if ($this->kodeRekening5 !== null) {
							...
							if ($this->kodeRekening6 !== null) {
								$this->kodeRekening6 = str_pad($this->kodeRekening6, 2, "0", STR_PAD_LEFT);
