...
#[Entity(table: "perencanaan_kabupaten_log")]
class PerencanaanKabupatenLogEntity
{
	...
	#[Column(name: "nama", type: "varchar", size: "323")]
	public string|null $nama;

	#[Column(name: "keterangan", type: "varchar", size: "36")]
