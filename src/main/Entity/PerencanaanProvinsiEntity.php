...
#[Entity(table: "perencanaan_provinsi")]
class PerencanaanProvinsiEntity extends AbstractEntity
{
	#[Id]
	 ...
	 */
	public function log(): PerencanaanProvinsiLogEntity
	{
		$logEntity = new PerencanaanProvinsiLogEntity();
